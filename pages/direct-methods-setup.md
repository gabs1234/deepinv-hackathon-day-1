...
<img src="/phase-retrieval/multi-distance-setup.svg" alt="CeTZ schematic of the Huhn bead experiment, not to scale. A waveguide point source illuminates the same sample at four successive source-to-sample positions: 156, 158, 166, and 187 millimetres. The detector remains 5.178 metres from the source. Source-to-sample and sample-to-detector distances are labelled for one acquisition." class="w-full h-60 object-contain" />

Registered data at **8 keV**: equivalent plane-wave distances on the common 196 nm grid:

$$
z_j = (155.89, 157.90, 165.95, 185.95) "mm"
$$

<div class="text-sm mt-4">

[Huhn et al. (2022), Table 1](https://arxiv.org/html/2205.01099v2) · bead data at 8 keV; geometry not to scale.
...
| Pixel pitch on the common object grid | 196 nm |
...
<!--
All physical lengths refer to the common registered object-plane grid.
